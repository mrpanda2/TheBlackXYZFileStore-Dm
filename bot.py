...
from TheBlack.server import web_server
...
from TheBlack.utils.keepalive import ping_server
from TheBlack.bot.clients import initialize_clients
...
async def start():
    ...
    for name in files:
        with open(name) as a:
            ...
            print("TheBlack Imported => " + plugin_name)
    if Var.ON_HEROKU:
